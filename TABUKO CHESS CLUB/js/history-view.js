    ...
    container.innerHTML = `
      <div class="hq-dash">
        ...
        <div class="hq-stats-grid">
          <div class="hq-stat-card"><div class="hq-stat-label">Lifetime Games</div><div class="hq-stat-value">${stats.totalGames}</div></div>
          <div class="hq-stat-card"><div class="hq-stat-label">Career Win Rate</div><div class="hq-stat-value" style="color:#10b981;">${stats.winRate}%</div></div>
